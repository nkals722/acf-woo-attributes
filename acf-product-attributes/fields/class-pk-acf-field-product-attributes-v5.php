...
class pk_acf_field_product_attributes extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*  var message = acf._e('product_attributes', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'pk-product-attributes'),
		);
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','pk-product-attributes'),
		}
